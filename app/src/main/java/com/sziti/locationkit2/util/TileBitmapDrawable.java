...
import com.sziti.locationkit2.LocationKitApplication;
import it.liuting.imagetrans.MathUtils;
...
public class TileBitmapDrawable extends Drawable {
    ...
    private static final class InitializationTask extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            ...
            final float minScale = Math.min(ImageCacheUtil.getScreenWidth(LocationKitApplication.Companion.getInstance()) / (float) decoder.getWidth(), ImageCacheUtil.getScreenHeight(LocationKitApplication.Companion.getInstance()) / (float) decoder.getHeight());
            ...
            try {
                ...
                if (null == bitmap) {
                    //下载的图片有问题,将其删掉
                    ImageCacheUtil.deleteFiles((String) params[0]);
